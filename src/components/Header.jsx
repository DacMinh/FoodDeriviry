...
const logout = () =>{
  ...
  return (
    <header className="fixed z-50 w-screen p-6 px-4 md:p-6 ">
        ...
        <div className="relative">
          ...
          >
            ...
            ">
              ...
              <p className="px-4 py-2 flex items-center gap-3 cursor-pointer bg-slate-200 hover:bg-slate-300  transition-all duration-100 ease-in-out text-textColor text-base
              m-2 p-2 rounded-md shadow-md" onClick={logout}>
               Đăng xuất<MdLogout />
              </p>
            </motion.div>
          )}
